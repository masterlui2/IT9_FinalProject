...
use App\Http\Controllers\PermitController;
    ...
    // For permits routes
    Route::post('/permits/clearance', [PermitController::class, 'storeClearance'])->name('permits.clearance.store');
    Route::post('/permits/residency', [PermitController::class, 'storeResidency'])->name('permits.residency.store');
    Route::post('/permits/business', [PermitController::class, 'storeBusiness'])->name('permits.business.store');
    Route::post('/permits/id', [PermitController::class, 'storeId'])->name('permits.id.store');

    // For AJAX loading requests
    Route::get('/my-permit-requests', [PermitController::class, 'getMyRequests']);

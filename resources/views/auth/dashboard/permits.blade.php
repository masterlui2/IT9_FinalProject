...
<body class="pt-3">
  <div class="container px-4 py-4" style="max-width: 1140px;">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <button class="btn btn-success px-4 py-2 rounded-2 fw-semibold">View Requests</button>
    </div>
    ...
    <div class="row">
      ...
      <!-- You can add a sidebar or additional content in the remaining 5 columns if needed -->
      <div class="col-md-5">
        <!-- Empty for now -->
      </div>
    </div> <!-- End main row -->
